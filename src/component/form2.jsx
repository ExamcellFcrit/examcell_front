...
export class form extends Component {
    ...
    jqccOnClick = () => {
        ...
        if (this.state.credentials.studentType === 'Dropout' || this.state.credentials.studentType == 'KT') {
    ...
    register = async (e) => {
        ...
        else if (this.state.credentials.studentType == 'Regular') {
            form_data.append('studentType', 'Regular')
            form_data.append('semester', this.state.credentials.semester)
            form_data.append('rollno', user.username);
            form_data.append('id', `${user.username}`)
        ...
        if (this.state.credentials.studentType === 'KT' || this.state.credentials.studentType === 'Dropout') {
    ...
    renderBranchSemester = () => {
        if (this.state.credentials.studentType == 'Regular' || this.state.credentials.studentType == 'KT') {
            return (
            ...
            return (
                <div className="column box">
                    <div className="title">KT Semester Details</div>
                    <div className="field" style={{ maxWidth: '400px' }}>
                        <label htmlFor="d1" className="label">Branch:</label>
                        <div className="select">
                            <select onChange={this.handleChange} name="branch">
    ...
    renderSelectedCourses = () => {
        if (this.state.credentials.studentType == 'Regular') {
            ...
            return (
                ...
                <div className="columns"  >
                    <div className="column box">
                        <div className="title is-4 has-text-success">Currents semester subjects</div>
                        <Grid
                            editField="inEdit"
                            onRowClick={this.rowClick}
                            onItemChange={this.itemChange}
                            style={{ width: '100%', border: '3px solid #34a85c' }}
                            data={this.state.isElective && this.state.finalcourse ? this.state.finalcourse.map((item) =>
                                ({ ...item })
                            ) : this.state.data.map((item) =>
                                ({ ...item })
                    ...
                    <div className="column box" >
                        <div className="title is-4 has-text-danger">KT semester subjects</div>
                        <Grid
                            editField="inEdit"
                            onRowClick={this.rowClick}
                            onItemChange={this.itemChange}
                            style={{ width: '100%', border: '3px solid #ff3a3af3' }}
    ...
    render() {
        ...
        return (
            <div >
                ...
                {this.state.filled || this.state.kt3filled || this.state.kt4filled || this.state.kt5filled || this.state.kt6filled ? (
                    ...
                    (
                        <div>
                                    ...
                                    <div className="container" >
                                        ...
                                        <div className="columns">
                                            ...
                                            {this.state.credentials.revscheme ? (
                                                <div className="column box">
                                                    <div className="title"> Filling form as a</div>
                                                    <Ripple>
                                                        <div className="field">
                                                            <div className="control" >
                            ...
                            <hr />
                            {this.state.credentials.semester || this.state.credentials.ktsemester ? (
                                <div>
                                    <div className="hero">
                                        <div className="section" >
                                            <div className="container">
